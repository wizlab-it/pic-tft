...
void TFT_WriteRegister(uint16_t reg, uint16_t data) {
PORTCbits.RC0 = 0;
{ PORTCbits.RC1 = 0; { uint8_t h = (reg)>>8, l = (uint8_t)reg; { PORTB = h; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; { PORTB = l; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; }; };
{ PORTCbits.RC1 = 1; { uint8_t h = (data)>>8, l = (uint8_t)data; { PORTB = h; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; { PORTB = l; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; }; };
PORTCbits.RC0 = 1;
}
...
uint8_t i = 0;
while(i != dataSize) {
{ PORTB = data[i++]; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; };
}
PORTCbits.RC0 = 1;
}
...
TRISB = 0xFF;
PORTCbits.RC1 = 1;
{ uint8_t hi; { PORTCbits.RC7 = 0; _delay((unsigned long)((1)*(24000000/4000000.0))); hi = PORTB; PORTCbits.RC7 = 1; }; { PORTCbits.RC7 = 0; _delay((unsigned long)((1)*(24000000/4000000.0))); data = PORTB; PORTCbits.RC7 = 1; }; data |= (hi << 8); };
PORTCbits.RC0 = 1;
TRISB = 0x00;
return data;
}
...
PORTCbits.RC7 = 1;
PORTCbits.RC2 = 0;;
_delay((unsigned long)((2)*(24000000/4000.0)));
PORTCbits.RC2 = 1;;
}
...
void TFT_Init(void) {
TFT_Reset();
_delay((unsigned long)((200)*(24000000/4000.0)));
...
while(blocks--) {
{ PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; };
{ PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; };
{ PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; };
{ PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; };
}
...
while(blocks--) {
{ PORTB = color_hi; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; { PORTB = color_lo; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; };
{ PORTB = color_hi; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; { PORTB = color_lo; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; };
{ PORTB = color_hi; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; { PORTB = color_lo; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; };
{ PORTB = color_hi; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; }; { PORTB = color_lo; { PORTCbits.RC6 = 0; PORTCbits.RC6 = 1; }; };
}
